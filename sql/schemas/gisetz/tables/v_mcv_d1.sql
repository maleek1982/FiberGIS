...
--
-- Name: v_mcv_d1; Type: TABLE; Schema: gisetz; Owner: -; Tablespace: 
--

CREATE TABLE v_mcv_d1 (
...
--
-- Name: v_mcv_d1_klm; Type: INDEX; Schema: gisetz; Owner: -; Tablespace: 
--

CREATE INDEX v_mcv_d1_klm ON v_mcv_d1 USING btree (mid, cabid, volid);


--
-- Name: v_mcv_d1_thegeom; Type: INDEX; Schema: gisetz; Owner: -; Tablespace: 
--

CREATE INDEX v_mcv_d1_thegeom ON v_mcv_d1 USING gist (the_geom);
